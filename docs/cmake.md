...
source archive. That published `DepoFile` points at the release archive and lists transparent
...
```cmake
set(DEPOS_BOOTSTRAP_VERSION "0.5.4" CACHE STRING "Pinned depos version used by this project" FORCE)
```
